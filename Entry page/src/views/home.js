  ...
  return (
    <div className="home-container">
      ...
      <div className="home-header">
        ...
        >
          <span className="logo">SPEECHIFY</span>
        ...
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            <h1 className="home-hero-heading heading1">
              AI-Enabled Digital Intervention for Children with Speech Delay
            </h1>
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>
                    Empowering children with speech delay through interactive
          ...
          <div className="home-features1">
            <div className="home-container02">
              ...
              <h2 className="home-features-heading heading2">
                AI-Enabled Digital Intervention Features
              </h2>
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Unlock the potential of your child&apos;s speech
        ...
        <div className="pricingContainer">
          <div className="home-container04">
            ...
            <h2 className="heading2">
              Choose the Perfect Plan for Your Child&apos;s Speech Development
            </h2>
            <span className="home-pricing-sub-heading bodyLarge">
              <span>
                <span>
                  Unlock the full potential of your child&apos;s language skills
                  with our AI-enabled digital intervention.
                </span>
              </span>
            </span>
          </div>
          <div className="home-container05">
            ...
            <div className="proPricingCard home-pricing-card2">
              <div className="home-container21">
                ...
                <span className="bodySmall">
                  Access to all games and activities with additional features
                </span>
              </div>
      ...
      <div className="home-banner">
        <div className="bannerContainer home-banner1">
          <h1 className="home-banner-heading heading2">
            Boost Language Skills and Development
          </h1>
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  Our AI-powered platform offers a wide range of engaging games
                  and activities designed to enhance vocabulary, grammar,
                  conversational skills, emotional intelligence, language
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container34">
              <Question1
                answer="AI-Enabled Digital Intervention for Children with Speech Delay is a program designed to help children with speech delay improve their language skills through various interactive activities and games."
                question="What is AI-Enabled Digital Intervention for Children with Speech Delay?"
              ></Question1>
              <Question1
                answer="The program includes word and matching games that are specifically designed to enhance vocabulary and grammar skills in children with speech delay."
                question="How does the program help in boosting vocabulary and grammar?"
              ></Question1>
              <Question1
                answer="Role-playing activities in the program help improve conversational skills and emotional intelligence in children with speech delay."
                question="What skills does role-playing enhance in children with speech delay?"
              ></Question1>
              <Question1
                answer="Puzzles and mazes included in the program improve language comprehension and motor skills in children with speech delay."
                question="How do puzzles and mazes benefit children with speech delay?"
              ></Question1>
              <Question1
                answer="Coloring activities in the program teach colors and actions to children with speech delay."
                question="What does coloring teach in the program?"
              ></Question1>
            </div>
          </div>
        </div>
